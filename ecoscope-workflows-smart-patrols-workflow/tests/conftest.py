...
from ecoscope_workflows_smart_patrols_workflow.app import app
from ecoscope_workflows_smart_patrols_workflow.formdata import FormData


ARTIFACTS = Path(__file__).parent.parent
TEST_CASES_YAML = ARTIFACTS.parent / "test-cases.yaml"
ENTRYPOINT = f"{sys.executable} -m ecoscope_workflows_smart_patrols_workflow.cli"
